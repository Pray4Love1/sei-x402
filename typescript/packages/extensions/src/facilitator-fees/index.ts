...
export { FACILITATOR_FEES } from "./types.js";
 ...
 *
 * NOTE:
 * Signature verification is intentionally NOT automatic.
 * Consumers MUST explicitly call verification helpers after extracting quotes,
 * since verification requires a crypto backend (ethers, viem, etc).
 *
 ...
 * Intended for clients that require fee-comparable routing.
 *
